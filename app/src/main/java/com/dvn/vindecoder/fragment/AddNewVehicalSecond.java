...
public class AddNewVehicalSecond extends Fragment implements DataComplete{
    ...
    public static AddNewVehicalSecond newInstance(String vid1) {
        AddNewVehicalSecond f = new AddNewVehicalSecond();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        vid=(String) getArguments().getString(
                V_ID);
