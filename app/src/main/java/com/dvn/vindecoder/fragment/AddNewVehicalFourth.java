...
public class AddNewVehicalFourth extends Fragment implements DataComplete{
    ...
    private Uri uri;
    private boolean checckBackPress;
    public String v_id;
   ...
   private String radio_emission="Yes";
    ...
    public static AddNewVehicalFourth newInstance(String vid1) {
        AddNewVehicalFourth f = new AddNewVehicalFourth();
