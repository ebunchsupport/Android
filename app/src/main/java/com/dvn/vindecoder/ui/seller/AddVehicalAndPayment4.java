...
import com.dvn.vindecoder.fragment.AddNewVehicalFourth;
import com.dvn.vindecoder.fragment.AddNewVehicalFragment;
import com.dvn.vindecoder.fragment.AddNewVehicalThird;
...
public class AddVehicalAndPayment4 extends BaseActivity implements AsyncCompleteListener,DataComplete{
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private boolean flagVar;
    private GetVehicalDto getVehicalDto;
    private AddNewVehicalFourth addNewVehicalFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            addNewVehicalFragment = AddNewVehicalFourth.newInstance(v_id);
    ...
    public void drawChildLayout() {
        ...
        mChildLayout.addView(
                inflateChildLayout(R.layout.activity_add_vehical_and_payment4),
                layoutParams);
    ...
    private void startDilog() {
        AlertDialog.Builder myAlertDilog = new AlertDialog.Builder(AddVehicalAndPayment4.this);
        ...
        myAlertDilog.setNegativeButton("Camera", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,AddVehicalAndPayment4.this)){
                        openCameraApplication();
                    }else{
                        requestPermission(AddVehicalAndPayment4.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                    }
                }else{
                    openCameraApplication();
                }
