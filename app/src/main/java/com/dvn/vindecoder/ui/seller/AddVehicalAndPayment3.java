...
public class AddVehicalAndPayment3 extends BaseActivity implements AsyncCompleteListener,DataComplete{
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private boolean flagVar;
    private GetVehicalDto getVehicalDto;
    private AddNewVehicalThird addNewVehicalFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            addNewVehicalFragment = AddNewVehicalThird.newInstance(v_id);
    ...
    public void drawChildLayout() {
        ...
        mChildLayout.addView(
                inflateChildLayout(R.layout.activity_add_vehical_and_payment3),
                layoutParams);
    ...
    private void startDilog() {
        AlertDialog.Builder myAlertDilog = new AlertDialog.Builder(AddVehicalAndPayment3.this);
        ...
        myAlertDilog.setNegativeButton("Camera", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
                    if(checkPermission(Manifest.permission.CAMERA,AddVehicalAndPayment3.this)){
                        openCameraApplication();
                    }else{
                        requestPermission(AddVehicalAndPayment3.this,new String[]{Manifest.permission.CAMERA},REQUEST_ACESS_CAMERA);
                    }
                }else{
                    openCameraApplication();
                }
