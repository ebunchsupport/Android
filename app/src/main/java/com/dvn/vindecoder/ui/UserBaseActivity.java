...
import com.dvn.vindecoder.ui.user.CompleteCarList;
import com.dvn.vindecoder.ui.user.ProcessCarList;
import com.dvn.vindecoder.ui.user.RejectedCarList;
import com.dvn.vindecoder.ui.user.UserDetail;
import com.dvn.vindecoder.util.LoginDB;


public abstract class UserBaseActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_base_layout);
        ...
        alertDialogBuilder = new AlertDialog.Builder(UserBaseActivity.this);
      ...
      //  filter.addAction("android.location.PROVIDERS_CHANGED");
        ...
        home_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UserBaseActivity.this,UserDetail.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.complete_car:
                ...
                Intent s_intent = new Intent(UserBaseActivity.this, CompleteCarList.class);
                startActivity(s_intent);
                overridePendingTransition(R.anim.on_intent_in, R.anim.on_intent_out);
                break;
            case R.id.rejected_car:
                Intent r_intent = new Intent(UserBaseActivity.this, RejectedCarList.class);
                startActivity(r_intent);
                overridePendingTransition(R.anim.on_intent_in, R.anim.on_intent_out);
                break;
            case R.id.process_car:
                // Toast.makeText(this, "Clicked: Menu No. 3 - SubMenu No .3", Toast.LENGTH_SHORT).show();
                Intent p_intent = new Intent(UserBaseActivity.this, ProcessCarList.class);
                startActivity(p_intent);
                overridePendingTransition(R.anim.on_intent_in, R.anim.on_intent_out);
                break;
            case R.id.logout:
                // Toast.makeText(this, "Clicked: Menu No. 3 - SubMenu No .3", Toast.LENGTH_SHORT).show();
                LoginDB.setLoginFlag(UserBaseActivity.this, false);
                Intent i = new Intent(UserBaseActivity.this, LoginActivity.class);
