...
public abstract class SellerBaseActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_base);
        ...
        alertDialogBuilder = new AlertDialog.Builder(SellerBaseActivity.this);
...
//           getActionBar().setBackgroundDrawable(getResources().);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.add_user:
                ...
                Intent s_intent = new Intent(SellerBaseActivity.this, SignUpAsSellerUSER.class);
            ...
            case R.id.user:
                // Toast.makeText(this, "Clicked: Menu No. 3 - SubMenu No .3", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(SellerBaseActivity.this, UserSellerList.class);
                startActivity(intent);
                overridePendingTransition(R.anim.on_intent_in, R.anim.on_intent_out);
                break;
            case R.id.logout:
                // Toast.makeText(this, "Clicked: Menu No. 3 - SubMenu No .3", Toast.LENGTH_SHORT).show();
                LoginDB.setLoginFlag(SellerBaseActivity.this, false);
                Intent i = new Intent(SellerBaseActivity.this, LoginActivity.class);
            ...
            case R.id.add_un_assigned_car:
                // Toast.makeText(this, "Clicked: Menu No. 3 - SubMenu No .3", Toast.LENGTH_SHORT).show();
                Intent s_intent1 = new Intent(SellerBaseActivity.this, UnAssignedCarList.class);
    ...
    public abstract void ChkScreen();
