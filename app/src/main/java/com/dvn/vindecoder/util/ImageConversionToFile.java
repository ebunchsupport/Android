...
public class ImageConversionToFile extends AsyncTask<String, String, String> {
    ProgressDialog pd;
    ...
    String doc_name;
    Bitmap bitmap;
    public ImageConversionToFile(Context mContext, DataComplete dataComplete, int postion, ImageView imageView, String doc_name) {
